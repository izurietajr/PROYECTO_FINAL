...
\label{sec:orgbb67597}
\subsubsection{Objetivo general}
\label{sec:orgc9e2741}
\begin{itemize}
...
\caption{\label{fig:org0a82cbd}Partes de una hoja.}
\end{figure}

\section{Desarrollo}
\label{sec:org7aa573f}
...
\caption{\label{fig:orga43e3da}Histograma de la imagen en blanco y negro, se puede apreciar un valle entre los valores 50 a 100 que separa dos grupos de colores.}
\end{figure}

Como se ve en la imagen \ref{fig:orga43e3da}, el histograma bimodal tiene una clara
...
resultado es algo similar a la figura \ref{fig:orgfe8bdd8}.

\begin{figure}[htbp]
\centering
\includegraphics[width=5cm]{./images/binaryleaf.png}
\caption{\label{fig:orgfe8bdd8}Imagen binarizada tomando el valor 75 para separar los umbrales de color.}
\end{figure}
...
\caption{\label{fig:orgdff3fa4}Imagen de una estrella con transformaciones, primero la imagen original, luego escalada, luego rotada y finalmente escalada y deformada.}
\end{figure}
