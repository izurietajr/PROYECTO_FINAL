...
\label{sec:org191d72b}
\subsubsection{Objetivo general}
\label{sec:org5a7a683}
\begin{itemize}
...
\caption{\label{fig:org99f3bff}Partes de una hoja.}
\end{figure}

\section{Desarrollo}
\label{sec:org19075c5}
...
\caption{\label{fig:org068ab8d}Histograma de la imagen en blanco y negro, se puede apreciar un valle entre los valores 50 a 100 que separa dos grupos de colores.}
\end{figure}

Como se ve en la imagen \ref{fig:org068ab8d}, el histograma bimodal tiene una clara
...
resultado es algo similar a la figura \ref{fig:orgfc8b4da}.

\begin{figure}[htbp]
\centering
\includegraphics[width=5cm]{./images/binaryleaf.png}
\caption{\label{fig:orgfc8b4da}Imagen binarizada tomando el valor 75 para separar los umbrales de color.}
\end{figure}
...
\caption{\label{fig:org4dc84d8}Imagen de una estrella con transformaciones, primero la imagen original, luego escalada, luego rotada y finalmente escalada y deformada.}
\end{figure}
...
En la figura \ref{fig:org6e41e5b} podemos ver cómo se distribuyen los momentos de las imágenes en el plano.

\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/moments.jpg}
\caption{\label{fig:org6e41e5b}Distribución de momentos invariantes por tipo de hoja en el plano \(\phi_1, \phi_2\).}
\end{figure}

\subsection{Comparación y clasificación}
\label{sec:org535ceaa}
